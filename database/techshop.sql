...
ALTER TABLE `chi_tiet_gio_hang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uc_cart_product` (`id_gio_hang`,`id_san_pham`),
...
ALTER TABLE `gio_hang`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id_nguoi_dung_unique` (`id_nguoi_dung`);
...
--
ALTER TABLE `chi_tiet_gio_hang`
  ADD CONSTRAINT `fk_cart_cart` FOREIGN KEY (`id_gio_hang`) REFERENCES `gio_hang` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `gio_hang`
  ADD CONSTRAINT `fk_cart_user_explicit` FOREIGN KEY (`id_nguoi_dung`) REFERENCES `nguoi_dung` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
