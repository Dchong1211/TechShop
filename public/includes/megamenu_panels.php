...
<div class="sidebar-megamenu-panel" id="megamenu-laptop-gaming">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
      <div class="megamenu-grid-column">
        <h4>Thương hiệu</h4>
...
<div class="sidebar-megamenu-panel" id="megamenu-pc-gvn">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
...
<div class="sidebar-megamenu-panel" id="megamenu-main-cpu-vga">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
...
<div class="sidebar-megamenu-panel" id="megamenu-case-psu-fan">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
...
<div class="sidebar-megamenu-panel" id="megamenu-storage-ram">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
...
<div class="sidebar-megamenu-panel" id="megamenu-audio-webcam">
...
<div class="sidebar-megamenu-panel" id="megamenu-monitor">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
      <h4>Hãng sản xuất</h4>
...
<div class="sidebar-megamenu-panel" id="megamenu-keyboard">
  <div class="megamenu-grid-container" style="grid-template-columns: repeat(5, 1fr);">
    <div class="megamenu-grid-column">
      <h4>Thương hiệu</h4>
