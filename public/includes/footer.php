    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (toggleButton) {
        toggleButton.addEventListener('click', function() {
          ...
          localStorage.setItem('theme', newTheme); // Lưu lựa chọn

          // Xử lý file CSS
          const darkThemeLink = document.getElementById('dark-theme-link');
          if (newTheme === 'dark') {
            // Nếu là dark mode và file CSS chưa có -> Tải file CSS dark
            if (!darkThemeLink) {
            ...
            // Nếu là light mode và file CSS dark đang có -> Xóa file CSS dark
            if (darkThemeLink) {
