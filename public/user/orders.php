...
$activePage  = 'orders';   // để sidebar highlight đúng

// CSS: dùng chung account + riêng orders
ob_start();
?>
          ...
          <?php foreach (array_reverse($orders) as $o): ?>
            <tr>
              ...
              <td style="text-align:right">
                <a class="btn btn-view" href="public/user/orders_detail.php?id=<?= urlencode($o['id']) ?>">
                  Xem chi tiết
                </a>
              </td>
            </tr>
